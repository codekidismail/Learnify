// =========================
// SOCIAL SCIENCE QUIZ TIMER + SUBMISSION
// =========================

// Disable auto-scroll restore
if ("scrollRestoration" in history) history.scrollRestoration = "manual";

// SAFER TIMER RESTORE FIX
window.addEventListener("pageshow", () => {
    const end = Number(localStorage.getItem("socialScienceQuizEndTime"));

    // If timer expired OR too small (like < 60 seconds), reset it
